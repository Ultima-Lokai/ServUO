...
namespace Server.Items
{
    ...
    public class MagicCrystalBall : Item, TranslocationItem
    {
        ...
        private const bool m_NeedSkillToRemain = true;
        private const bool m_NeedSkillToAct = true;

        private SkillNameValue m_FollowSkill = new SkillNameValue(SkillName.Magery, 70);
        private SkillNameValue m_FollowSecondSkill = new SkillNameValue(SkillName.Snooping, 50);
        ...
        private class SubjectLinkTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is Mobile)
                {
                    ...
                    {
                        from.SendMessage("You have successfully connected the Crystal Ball to your subject.");
        ...
        public void DisconnectSubject(Mobile from)
        {
            if (!Deleted && Subject != null)
            {
                ...
                from.SendMessage("The crystal ball is no longer linked to a subject.");
            }
        }
