...
{
    public class BranchBanker : BaseVendor
    {
        ...
        [Constructable]
        public BranchBanker()
            : base("the branch banker")
        {
        }

        public override void InitSBInfo()
        {
            m_SBInfos.Add(new SBBranchBanker());
        }
        ...
        public BranchBanker(Serial serial)
            : base(serial)
        {
        }
                        ...
                        case 0x0002: // *bank*
                            {
                                ...
                                e.Mobile.SendGump(new BranchBankGump(e.Mobile, this));
        ...
        {
            if (from.Alive)
                list.Add(new OpenBranchBankEntry(from, this));
