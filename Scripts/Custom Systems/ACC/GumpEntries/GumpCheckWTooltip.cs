...
{
	public class GumpCheckWTooltip : GumpEntry
	{
		private int m_X, m_Y;
		...
		public GumpCheckWTooltip( int x, int y, int inactiveID, int activeID, bool initialState, int switchID, int tooltip )
		{
			m_X = x;
			m_Y = y;
			m_ID1 = inactiveID;
		...
		{
			return String.Format( "{{ checkbox {0} {1} {2} {3} {4} {5} }}{{ tooltip {6} }}", m_X, m_Y, m_ID1, m_ID2, m_InitialState ? 1 : 0, m_SwitchID, m_Tooltip );
		}
