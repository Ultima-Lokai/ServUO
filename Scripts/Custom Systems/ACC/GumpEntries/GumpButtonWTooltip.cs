...
{
	public class GumpButtonWTooltip : GumpEntry
	{
		private int m_X, m_Y;
		...
		public GumpButtonWTooltip( int x, int y, int normalID, int pressedID, int buttonID, GumpButtonType type, int param, int tooltip )
		{
			m_X = x;
			m_Y = y;
			m_ID1 = normalID;
		...
		{
			return String.Format( "{{ button {0} {1} {2} {3} {4} {5} {6} }}{{ tooltip {7} }}",  m_X, m_Y, m_ID1, m_ID2, (int)m_Type, m_Param, m_ButtonID, m_Tooltip );
		}
