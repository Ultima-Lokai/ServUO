...
{
    public static class Technological
    {
        public static int TotalTechnology(CivEntry civ)
        {
            Building build;
            BuildingType b;
            int total = 0;
