...
namespace Server.UOC.Technologies
{
    public sealed class Mining
    {
        ...
        {
            TechType m_TechType = TechType.Mining;
            SkillName[] m_SkillsAllowed = new SkillName[] { SkillName.Mining };
            GovernmentType m_GovernmentRequired = GovernmentType.Anarchy;
            TechType[] m_TechsRequired = new TechType[] { TechType.None };
            string m_Description = "Mining temporary description.";
            string m_Name = "Mining";
            int m_Cost = 0;
