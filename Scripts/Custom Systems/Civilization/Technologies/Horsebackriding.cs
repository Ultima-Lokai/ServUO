...
{
    public sealed class Horsebackriding
    {
        public static void Initialize()
        {
            TechType m_TechType = TechType.Horsebackriding;
            LokaiSkillName[] m_SkillsAllowed = new LokaiSkillName[] { LokaiSkillName.AnimalRiding };
            GovernmentType m_GovernmentRequired = GovernmentType.Anarchy;
            TechType[] m_TechsRequired = new TechType[] { TechType.None };
            string m_Description = "Horsebackriding temporary description.";
            string m_Name = "Horsebackriding";
            int m_Cost = 0;
