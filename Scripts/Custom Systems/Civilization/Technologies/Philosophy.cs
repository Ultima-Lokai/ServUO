...
{
    public sealed class Philosophy
    {
        public static void Initialize()
        {
            TechType m_TechType = TechType.Philosophy;
            SkillName[] m_SkillsAllowed = new SkillName[] { SkillName.Cooking };
            GovernmentType m_GovernmentRequired = GovernmentType.Anarchy;
            TechType[] m_TechsRequired = new TechType[] { TechType.Astronomy };
            string m_Description = "Philosophy temporary description.";
            string m_Name = "Philosophy";
            int m_Cost = 0;
