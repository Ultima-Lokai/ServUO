...
{
    public sealed class Roadbuilding
    {
        public static void Initialize()
        {
            TechType m_TechType = TechType.Roadbuilding;
            SkillName[] m_SkillsAllowed = new SkillName[] { SkillName.Stealth };
            GovernmentType m_GovernmentRequired = GovernmentType.Anarchy;
            TechType[] m_TechsRequired = new TechType[] { TechType.Mining };
            string m_Description = "Roadbuilding temporary description.";
            string m_Name = "Roadbuilding";
            int m_Cost = 20000;
