...
{
	public class SmallGoldNugget : Item, ICommodity
    {
    ...
    public class MediumGoldNugget : Item, ICommodity
    {
		bool ICommodity.IsDeedable { get { return true; } }
        int ICommodity.DescriptionNumber { get { return LabelNumber; 
        } 
    ...
    public class LargeGoldNugget : Item, ICommodity
    {
		bool ICommodity.IsDeedable { get { return true; } }
    ...
    public class GoldBrick : Item, ICommodity
    {
		bool ICommodity.IsDeedable { get { return true; } }
        int ICommodity.DescriptionNumber
        {
