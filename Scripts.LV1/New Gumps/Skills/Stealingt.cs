...
{
    public class Stealingt : Gump
    {
        public Stealingt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee55, 0xee55, 1, GumpButtonType.Reply, 0);
