...
{
    public class EvalIntt : Gump
    {
        public EvalIntt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee4b, 0xee4b, 1, GumpButtonType.Reply, 0);
