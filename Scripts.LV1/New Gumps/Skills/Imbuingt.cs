...
{
    public class Imbuingt : Gump
    {
        public Imbuingt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee4d, 0xee4d, 1, GumpButtonType.Reply, 0);
