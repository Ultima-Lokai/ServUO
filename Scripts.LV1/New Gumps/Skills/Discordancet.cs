...
{
    public class Discordancet : Gump
    {
        public Discordancet(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee57, 0xee57, 1, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    pm.UseSkill(15);
                    pm.CloseGump(typeof(Discordancet));
