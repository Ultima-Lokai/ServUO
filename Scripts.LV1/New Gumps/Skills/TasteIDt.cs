...
{
    public class TasteIDt : Gump
    {
        public TasteIDt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee48, 0xee48, 1, GumpButtonType.Reply, 0);
