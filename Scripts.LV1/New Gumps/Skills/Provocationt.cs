...
{
    public class Provocationt : Gump
    {
        public Provocationt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee59, 0xee59, 1, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    pm.UseSkill(0x16);
                    pm.CloseGump(typeof(Provocationt));
