...
{
    public class SpiritSpeakt : Gump
    {
        public SpiritSpeakt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee4e, 0xee4e, 1, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    pm.UseSkill(0x20);
                    pm.CloseGump(typeof(SpiritSpeakt));
