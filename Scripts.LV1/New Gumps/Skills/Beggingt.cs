...
{
    public class Beggingt : Gump
    {
        public Beggingt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee45, 0xee45, 1, GumpButtonType.Reply, 0);
