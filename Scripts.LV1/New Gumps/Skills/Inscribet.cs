...
{
    public class Inscribet : Gump
    {
        public Inscribet(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee4a, 0xee4a, 1, GumpButtonType.Reply, 0);
