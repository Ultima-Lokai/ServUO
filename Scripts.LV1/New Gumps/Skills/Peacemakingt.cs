...
{
    public class Peacemakingt : Gump
    {
        public Peacemakingt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee58, 0xee58, 1, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    pm.UseSkill(9);
                    pm.CloseGump(typeof(Peacemakingt));
