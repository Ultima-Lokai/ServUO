...
{
    public class Meditationt : Gump
    {
        public Meditationt(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee4c, 0xee4c, 1, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                case 1:
                    pm.UseSkill(0x2e);
                    pm.CloseGump(typeof(Meditationt));
