...
{
    public class ArmsLoret : Gump
    {
        public ArmsLoret(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee44, 0xee44, 1, GumpButtonType.Reply, 0);
