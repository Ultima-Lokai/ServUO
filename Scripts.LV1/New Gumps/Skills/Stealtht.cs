...
{
    public class Stealtht : Gump
    {
        public Stealtht(PlayerMobile pm) : base(0, 0)
        {
            Closable = true;
            Disposable = true;
            Dragable = true;
            ...
            AddButton(0x74, 0x73, 0xee56, 0xee56, 1, GumpButtonType.Reply, 0);
