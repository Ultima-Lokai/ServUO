...
namespace Server.Gumps
{
    public class SynthGump : Gump
    {
        ...
        private int m_Page;
        private bool m_Music, m_Keys, m_Recording, m_FileOptions;
        ...
        public SynthGump(Mobile from, int page)
            : this(from, page, 0, false, false, false, false, new bool[]{ false, false, false, false, false, false, false, false, false}, 
            new List<string>(), "Untitled", new List<XmlMusic>())
        {
        }

        public SynthGump(Mobile from, int page, int instrument, bool music, bool keys, bool recording, bool fileoptions, bool[] mixer,
            ...
            : base(0, 0)
        {
            ...
            AddPage(0);
            AddBackground(31, 2, 708, 28, 9200);
            AddLabel(340, 7, labelhue, "The Synthesizer by Lokai");
            ...
            AddImageTiled(119, 73, 20, 21, 11374);
            AddImageTiled(141, 73, 20, 21, 11374);
            AddImageTiled(163, 73, 20, 21, 11374);
            AddImageTiled(185, 73, 20, 21, 11374);
            AddImageTiled(207, 73, 20, 21, 11374);
            AddImageTiled(229, 73, 20, 21, 11374);
            AddImageTiled(251, 73, 20, 21, 11374);
            ...
            if (keys)
            {
                AddLabel(125, 101, labelhue, "C");
                AddLabel(147, 101, labelhue, "D");
                AddLabel(169, 101, labelhue, "E");
                AddLabel(191, 101, labelhue, "F");
                AddLabel(213, 101, labelhue, "G");
                AddLabel(235, 101, labelhue, "A");
                AddLabel(257, 101, labelhue, "B");
            ...
            if (fileoptions)
            {
                AddBackground(31, 123, 708, 28, 9200);
                AddBackground(31, 154, 73, 274, 9200);
                AddTextEntry(119, 127, 213, 20, 0, 0, m_Name);
        ...
        public enum Buttons
        {
            ...
            n22_a_high, n23_a_sharp_high, n24_b_high, n25_c_high, n26_Pause, RB1_Harp, RB2_LapHarp, RB3_Lute, RB4_Drums, ShowMusic,
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.ButtonID > 100)
            {
                ...
                from.SendGump(new SynthGump(m_From, m_Page, (int)inst, m_Music, m_Keys, m_Recording, m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks));
            }
            ...
            else
            {
                ...
                {
                    case (int)Buttons.Quit: break;
                    case (int)Buttons.ShowKeys: from.SendGump(new SynthGump(m_From, m_Page, (int)inst, m_Music, !m_Keys, m_Recording, m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks)); break;
                    case (int)Buttons.ShowMusic: from.SendGump(new SynthGump(m_From, m_Page, (int)inst, !m_Music, m_Keys, m_Recording, m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks)); break;
                    case (int)Buttons.ShowMixer:
                        {
                            m_Mixer[0] = !m_Mixer[0];
                            from.SendGump(new SynthGump(m_From, m_Page, (int)inst, m_Music, m_Keys, m_Recording, m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks)); break;
                        }
                    case (int)Buttons.StartRecording:
                        {
                            ...
                            else
                            {
                                ...
                                m_Song.Add("norm");
                                from.SendGump(new SynthGump(m_From, m_Page, (int)inst, m_Music, m_Keys, true, m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks));
                            }
                            break;
                        }
                    ...
                    case (int)Buttons.FileOptions: from.SendGump(new SynthGump(m_From, m_Page, (int)inst, m_Music, m_Keys, m_Recording, !m_FileOptions, m_Mixer, m_Song, m_Name, m_MusicTracks)); break;
